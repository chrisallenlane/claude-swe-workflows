...
2. **Take the branch.** Even if the advisory phases make no changes, `/review-arch`, `/review-test`, `/review-doc`, and `/review-release` all can. Accepting the `review-deep/<date>` branch keeps `main`/`master` clean while you work.
